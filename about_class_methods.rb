...
class AboutClassMethods < Neo::Koan
  ...
  #
  # I prefer using self.method for a few methods, however
  # if I need to defined multiple class methods it might be
  # cleaner to open class << self and define methods within.
  # ------------------------------------------------------------------
